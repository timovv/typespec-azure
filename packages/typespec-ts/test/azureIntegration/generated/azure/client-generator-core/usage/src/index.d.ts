...
export declare type ModelInReadOnlyPropertyParameters = ModelInReadOnlyPropertyBodyParam &
  RequestParameters;

export declare interface OrphanModelSerializable {
  put(
    options: OrphanModelSerializableParameters,
  ): StreamableMethod<OrphanModelSerializable204Response>;
}
...
export declare type OrphanModelSerializableParameters = OrphanModelSerializableBodyParam &
  RequestParameters;
