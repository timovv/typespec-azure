...
describe("ModelPropertyAdditional Client", () => {
  ...
  // TODO: https://github.com/Azure/autorest.typescript/issues/3122
  it.skip("should get spread Record NonDiscriminated Union value", async () => {
    const result = await client.spreadRecordNonDiscriminatedUnion.get();
    assert.deepEqual(result, {
      name: "abc",
      additionalProperties: {
  ...
  // TODO: https://github.com/Azure/autorest.typescript/issues/3122
  it.skip("should put spread Record NonDiscriminated Union value", async () => {
    const result = await client.spreadRecordNonDiscriminatedUnion.put({
      name: "abc",
      additionalProperties: {
        prop1: {
  ...
  // TODO: https://github.com/Azure/autorest.typescript/issues/3122
  it.skip("should get spread Record NonDiscriminated Union2 value", async () => {
  ...
  // TODO: https://github.com/Azure/autorest.typescript/issues/3122
  it.skip("should put spread Record NonDiscriminated Union2 value", async () => {
  ...
  // TODO: https://github.com/Azure/autorest.typescript/issues/3122
  it.skip("should get spread Record NonDiscriminated Union3 value", async () => {
  ...
  // TODO: https://github.com/Azure/autorest.typescript/issues/3122
  it.skip("should put spread Record NonDiscriminated Union3 value", async () => {
