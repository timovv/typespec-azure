...
export declare type PropertySafeintAsStringParameters = PropertySafeintAsStringBodyParam &
  RequestParameters;
...
export declare type PropertyUint32AsStringOptionalParameters =
  PropertyUint32AsStringOptionalBodyParam & RequestParameters;
...
export declare type PropertyUint8AsStringParameters = PropertyUint8AsStringBodyParam &
  RequestParameters;
...
export declare interface SafeintAsString {
  post(
    options: PropertySafeintAsStringParameters,
  ): StreamableMethod<PropertySafeintAsString200Response>;
}
...
export declare interface Uint32AsStringOptional {
  post(
    options: PropertyUint32AsStringOptionalParameters,
  ): StreamableMethod<PropertyUint32AsStringOptional200Response>;
}
...
export declare interface Uint8AsString {
  post(
    options: PropertyUint8AsStringParameters,
  ): StreamableMethod<PropertyUint8AsString200Response>;
}
