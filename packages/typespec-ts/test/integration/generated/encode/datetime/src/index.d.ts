...
export declare type HeaderUnixTimestampArrayParameters = HeaderUnixTimestampArrayHeaderParam &
  RequestParameters;
...
export declare type HeaderUnixTimestampParameters = HeaderUnixTimestampHeaderParam &
  RequestParameters;
...
export declare type PropertyUnixTimestampArrayParameters = PropertyUnixTimestampArrayBodyParam &
  RequestParameters;
...
export declare type PropertyUnixTimestampParameters = PropertyUnixTimestampBodyParam &
  RequestParameters;
...
export declare type QueryUnixTimestampArrayParameters = QueryUnixTimestampArrayQueryParam &
  RequestParameters;
